            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-my-nav-link href="/posts" :current="request()->is('posts')">Post</x-my-nav-link>
                          ...
                          @if (Auth::check())
                            ...
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="size-8 rounded-full"
                                    ...
                                    alt="" />
                                    <div class="text-white ml-3"> {{ Auth::user()->name }}</div>
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                ...
                                <form  method="POST" action="/logout">
                                    @csrf
                            <button type="submit" href="#" class="block px-4 py-2 text-sm text-gray-700 cursor-pointer" role="menuitem"
