        ...
        <div class="bg-white dark:bg-gray-800 relative border-md sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="/dashboard/create" id="createProductModalButton13" data-modal-target="createProductModal13"
                        data-modal-toggle="createProductModal13"
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="post-{{ $post->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="post-{{ $post->id }}-dropdown-button">
                                            ...
                                            <li>
                                                <a href="/dashboard/{{ $post->slug }}" data-modal-target="readProductModal2"
                                                    data-modal-toggle="readProductModal2"
                                                    class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                        viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
